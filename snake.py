...
while True:
    ...
    # linux
    if (event == 'Up:111'    or event == 'w:25' or event == 'W:25') and not direction == DIRECTIONS['down']:  direction = DIRECTIONS['up']
    if (event == 'Right:114' or event == 'd:40' or event == 'D:40') and not direction == DIRECTIONS['left']:  direction = DIRECTIONS['right']
    if (event == 'Down:116'  or event == 's:39' or event == 'S:39') and not direction == DIRECTIONS['up']:    direction = DIRECTIONS['down']
    if (event == 'Left:113'  or event == 'a:38' or event == 'A:38') and not direction == DIRECTIONS['right']: direction = DIRECTIONS['left']
